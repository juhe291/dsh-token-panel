				...
				children: [
					(0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							(0, react_jsx_runtime.jsx)("div", {
								...
								children: (0, react_jsx_runtime.jsx)("span", { children: t("summaryTitle") })
							}),
							(0, react_jsx_runtime.jsxs)("div", {
							...
							effectiveBalance !== null && (0, react_jsx_runtime.jsxs)("div", {
							...
							(0, react_jsx_runtime.jsx)("div", {
								className: TokenHud_module_css_default.editNote,
								children: t("balanceLocalNote")
							})
						]
					}),
					hasData && (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							className: TokenHud_module_css_default.sectionLabel,
							children: [(0, react_jsx_runtime.jsx)("span", { children: t("trendTitle") }), (0, react_jsx_runtime.jsxs)("div", {
					...
					hasData && listCount > 0 && (0, react_jsx_runtime.jsxs)("section", {
						className: TokenHud_module_css_default.section,
						children: [
							(0, react_jsx_runtime.jsxs)("div", {
								className: TokenHud_module_css_default.sectionLabel,
								children: [(0, react_jsx_runtime.jsx)("span", { children: subView === "months" ? t("byMonth") : t("byDay") }), (0, react_jsx_runtime.jsx)("span", {
									className: TokenHud_module_css_default.sectionCount,
									children: subView === "months" ? fill(t("monthsCount"), { count: listCount }) : fill(t("daysCount"), { count: listCount })
								})]
							}),
		...
		function TokenHud({ t, sessionsList }) {
			...
			*  visible — otherwise an off-screen target looks like "nothing moved". */
			...
			const totalCostNow = (0, react.useMemo)(() => {
				...
				return stats.months.reduce((sum, month) => sum + estimateCost(month.input, month.cacheRead, month.cacheWrite, month.output, sp), 0);
			}, [stats]);
								...
								children: [(0, react_jsx_runtime.jsxs)("span", {
									...
									children: [(0, react_jsx_runtime.jsxs)("span", {
										...
										children: [
											t("costNow"),
											" ",
											(0, react_jsx_runtime.jsxs)("b", { children: ["¥", totalCostNow.toFixed(2)] })
										]
									}), (0, react_jsx_runtime.jsx)("span", {
										className: TokenHud_module_css_default.mono,
