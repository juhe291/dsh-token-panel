window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var TokenHud_module_css_default = {
			...
			"settingsText": "_7TU4uW_settingsText",
			...
			"settingsDesc": "_7TU4uW_settingsDesc",
			...
			"settingsSwitch": "_7TU4uW_settingsSwitch",
			...
			"settingsRow": "_7TU4uW_settingsRow",
			...
			"settingsTitle": "_7TU4uW_settingsTitle",
		...
		*  bottom corners land on the true bottom edge (not offset by a guess). */
		...
		function estimateTextW(text) {
			let width = 0;
			for (const ch of text) width += ch.charCodeAt(0) > 11903 ? 10 : 5.6;
			return width;
		}
		...
		function Sparkline({ points, now, width = 336, height = 80, tickFormat = formatTime, hover = false, follow = false, t }) {
			...
			*  at height-6 — each label gets an even ~25px band so nothing collides. */
			...
			const path = (0, react.useMemo)(() => {
				...
				const ordered = points.length > 1 && points[0].t > points[points.length - 1].t ? [...points].sort((a, b) => a.t - b.t) : points;
				if (ordered.length === 1) {
				...
				return {
					...
					ticks: follow ? [
						...
						return Array.from({ length: tickCount }, (_, i) => Math.round((ordered.length - 1) * i / (tickCount - 1))).map((index) => {
			...
			return (0, react_jsx_runtime.jsxs)("svg", {
				...
				children: [
					...
					hover && path.coords.slice(0, -1).map((point, index) => (0, react_jsx_runtime.jsx)("circle", {
						cx: point.x,
						cy: point.y,
						r: 8,
						fill: "transparent",
					...
					follow && path.kind === "line" && (0, react_jsx_runtime.jsx)("path", {
						d: path.line,
						fill: "none",
						stroke: "transparent",
						strokeWidth: 14,
					...
					(hover || follow) && hovered !== null && (follow || hovered < path.coords.length - 1) && path.coords[hovered] !== void 0 && (() => {
						...
						const by = fitsAbove ? point.y - BUBBLE_H - 9 : Math.min(point.y + 9, height - BUBBLE_H - 2);
						const bx = Math.min(Math.max(point.x, AXIS_W + labelW / 2 + 2), width - labelW / 2 - 2);
						return (0, react_jsx_runtime.jsxs)("g", {
							pointerEvents: "none",
							children: [
								follow && (0, react_jsx_runtime.jsx)("line", {
									x1: point.x,
									y1: TOP,
									x2: point.x,
									y2: BOT,
		...
		*  the thumb sits on the right at 0, media-player style. */
		function Scrubber({ offset, max, onChange, t }) {
			...
			return (0, react_jsx_runtime.jsx)("div", {
				className: TokenHud_module_css_default.scrubberWrap,
				children: (0, react_jsx_runtime.jsx)("input", {
					type: "range",
					className: TokenHud_module_css_default.scrubber,
					min: 0,
					max,
					step: max >= 6e4 ? 1e3 : 1,
					value: max - clamped,
					...
					onChange: (event) => {
						onChange(max - Number(event.currentTarget.value));
					}
				})
			});
		}
		...
		*  stay in sync and the HUD picks the change up within a poll tick. */
		function TokenPanelSettingsSection({ t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				className: TokenHud_module_css_default.settingsRow,
				children: [(0, react_jsx_runtime.jsxs)("div", {
					className: TokenHud_module_css_default.settingsText,
					children: [(0, react_jsx_runtime.jsx)("span", {
						className: TokenHud_module_css_default.settingsTitle,
						children: t("showHud")
					}), (0, react_jsx_runtime.jsx)("span", {
						className: TokenHud_module_css_default.settingsDesc,
						children: t("showHudDesc")
					})]
				}), (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					role: "switch",
					"aria-checked": hidden,
					className: TokenHud_module_css_default.settingsSwitch,
					"data-on": hidden,
					onClick: toggle,
					children: (0, react_jsx_runtime.jsx)("span", {
						className: TokenHud_module_css_default.settingsThumb,
						"aria-hidden": true
					})
				})]
			});
		...
		function StatsView({ stats, t, budgetMonthly, totalCost, effectiveBalance, editing, setEditing, editDraft, setEditDraft, editInputRef, onSave, onHint, onHintEnd }) {
			...
			const [statOffset, setStatOffset] = (0, react.useState)(0);
			const dayPoints = (0, react.useMemo)(() => stats === null ? [] : [...stats.days].sort((a, b) => a.date.localeCompare(b.date)).map((day) => ({
				t: Date.parse(`${day.date}T12:00:00`),
				total: day.total
			})), [stats]);
			const monthPoints = (0, react.useMemo)(() => stats === null ? [] : [...stats.months].sort((a, b) => a.month.localeCompare(b.month)).map((month) => ({
						...
						children: [
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [(0, react_jsx_runtime.jsxs)("div", {
									...
									}), renderEditor("budget", budgetMonthly > 0 ? budgetMonthly : null, budgetMonthly > 0 ? `${formatCost(monthCost, t)} / ${formatCost(budgetMonthly, t)}` : t("notSet"))]
					...
					hasData && (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)("div", {
								...
								children: subView === "months" ? windowMonthPoints.length >= 1 && (0, react_jsx_runtime.jsx)(Sparkline, {
									points: windowMonthPoints,
									now: Date.now(),
									height: 80.5,
									hover: true,
									tickFormat: (value) => formatMonthTick(value, t),
									t
								}) : windowDayPoints.length >= 1 && (0, react_jsx_runtime.jsx)(Sparkline, {
									points: windowDayPoints,
									now: Date.now(),
									height: 80.5,
									hover: true,
							...
							(0, react_jsx_runtime.jsx)(Scrubber, {
		...
		function TokenHud({ t, sessionsList }) {
			...
			const [liveOffset, setLiveOffset] = (0, react.useState)(0);
			...
			*  Effective balance = value − (current cumulative cost − baseline). */
			...
			const [userHidden, setUserHidden] = (0, react.useState)(() => {
				try {
					return window.localStorage.getItem("dsh-token-panel-hidden") === "1";
				} catch {
					return false;
			...
			*  (same flag) takes effect within a poll tick. */
			const prevHiddenRef = (0, react.useRef)(null);
			(0, react.useEffect)(() => {
				let lsHidden = false;
				try {
			...
			*  visible — otherwise an off-screen target looks like "nothing moved". */
			...
			const rawHistory = (0, react.useMemo)(() => {
				if (snapshot === null || snapshot.sessions.length === 0) return [];
				return ((currentSessionId !== void 0 ? snapshot.sessions.find((row) => row.sessionId === currentSessionId) : void 0) ?? snapshot.sessions[0])?.history ?? [];
			}, [snapshot, currentSessionId]);
			/** Furthest the live scrubber can go back while the window still has data. */
			const liveMaxOffset = (0, react.useMemo)(() => {
			...
			if (snapshot?.hidden === true || userHidden) return null;
					...
					pressMenu && (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)("button", {
								...
								children: (0, react_jsx_runtime.jsxs)("span", {
									className: TokenHud_module_css_default.pressMenuLabel,
									children: [(0, react_jsx_runtime.jsx)(MenuIcon, { d: ICON_EYE_OFF }), t("hideHud")]
								})
							}),
							(0, react_jsx_runtime.jsx)("button", {
								type: "button",
									...
									children: [
										...
										(0, react_jsx_runtime.jsx)("div", {
											...
											children: (0, react_jsx_runtime.jsx)(Sparkline, {
												points: topHistory,
												now: now - liveOffsetClamped,
												follow: true,
												t
											})
										}),
										(0, react_jsx_runtime.jsx)(Scrubber, {
											offset: liveOffsetClamped,
											max: liveMaxOffset,
											onChange: setLiveOffset,
											t
										})
									]
								}), (0, react_jsx_runtime.jsxs)("section", {
								...
								children: [
									(0, react_jsx_runtime.jsxs)("div", {
										...
										children: [(0, react_jsx_runtime.jsx)("span", {
											...
											children: error !== null ? fill(t("disconnected"), { error }) : view === "live" ? fill(t("pollLive"), {
												total: formatNumber(totals.cumulative),
									...
									(0, react_jsx_runtime.jsxs)("div", {
										...
										children: [(0, react_jsx_runtime.jsx)("span", {
											...
											className: TokenHud_module_css_default.footCost,
											children: (0, react_jsx_runtime.jsx)("b", { children: formatCost(totalCostNow, t) })
										})]
									}),
									(0, react_jsx_runtime.jsxs)("div", {
										className: `${TokenHud_module_css_default.footCol} ${TokenHud_module_css_default.footRightCol}`,
		...
		*/
		function apply(ctx) {
			const en = {
				...
				monthFmt: "{y}/{m}",
				pollLive: "Live · Cumulative {total} · Output {out}",
				...
				showHud: "Hide Token HUD",
				showHudDesc: "Turn on to hide the whole HUD (pill included).",
			...
			const zh = {
				...
				showHud: "隐藏Token HUD",
				showHudDesc: "开启后隐藏整个 HUD（含右下角胶囊）。",
