window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var TokenHud_module_css_default = {
			...
			"sparkBubbleValue": "_7TU4uW_sparkBubbleValue",
			"spark": "_7TU4uW_spark",
			"foot": "_7TU4uW_foot",
			"mono": "_7TU4uW_mono",
			"title": "_7TU4uW_title",
			...
			"sparkBubbleDate": "_7TU4uW_sparkBubbleDate",
			...
			*  at height-6 — each label gets an even ~25px band so nothing collides. */
			...
			return (0, react_jsx_runtime.jsxs)("svg", {
				...
				children: [
					...
					hover && path.coords.map((point, index) => (0, react_jsx_runtime.jsx)("circle", {
						cx: point.x,
						cy: point.y,
						r: 7,
						fill: "transparent",
					...
					hover && hovered !== null && path.coords[hovered] !== void 0 && (() => {
						...
						return (0, react_jsx_runtime.jsxs)("g", {
							...
							children: [
								...
								(0, react_jsx_runtime.jsx)("text", {
									...
									y: by + 9.5,
									textAnchor: "middle",
									className: TokenHud_module_css_default.sparkBubbleDate,
									children: dateText
								}),
								(0, react_jsx_runtime.jsx)("text", {
									x: bx,
									y: by + 19,
									textAnchor: "middle",
									className: TokenHud_module_css_default.sparkBubbleValue,
									children: valueText
								})
							]
						});
