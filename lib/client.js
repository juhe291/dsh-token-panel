			...
			*  at height-6 — each label gets an even ~25px band so nothing collides. */
			...
			return (0, react_jsx_runtime.jsxs)("svg", {
				...
				children: [
					...
					hover && path.kind === "line" && (0, react_jsx_runtime.jsx)("path", {
						d: path.line,
						fill: "none",
						stroke: "transparent",
						strokeWidth: 14,
					...
					hover && path.kind === "dot" && (0, react_jsx_runtime.jsx)("circle", {
						cx: path.x,
						cy: path.y,
						r: 8,
						fill: "transparent",
