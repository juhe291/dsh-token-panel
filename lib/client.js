		...
		function TokenHud({ t, sessionsList }) {
			...
			*  Driven by pointerup (not click), which pointer capture cannot steal. */
			...
			const goToDefault = () => {
				...
				if (def === null || def.kind === "corner") setPosition(null);
				else if (def.kind === "preset") setPosition(presetCornerPosition(def.preset));
				else setPosition({
					x: def.x,
					y: def.y
				});
						...
						children: [
							(0, react_jsx_runtime.jsx)("button", {
								...
								children: (0, react_jsx_runtime.jsxs)("span", {
									...
									children: [(0, react_jsx_runtime.jsx)(MenuIcon, { d: ICON_BACK }), defaultPos === null || defaultPos.kind === "corner" ? t("backToCorner") : defaultPos.kind === "preset" ? `${t("backToDefault")} · ${cornerLabel(defaultPos.preset, t)}` : t("backToDefault")]
								})
							}),
