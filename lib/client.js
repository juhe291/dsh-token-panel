			...
			return (0, react_jsx_runtime.jsxs)("svg", {
				...
				children: [
					...
					yLabels.map((label) => (0, react_jsx_runtime.jsx)("text", {
						...
						children: formatNumber(label.value)
					}, label.y)),
