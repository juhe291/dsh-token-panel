window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var TokenHud_module_css_default = {
			...
			"sparkPointLabel": "_7TU4uW_sparkPointLabel",
			"title": "_7TU4uW_title",
			...
			*  at height-6 — each label gets an even ~25px band so nothing collides. */
			...
			return (0, react_jsx_runtime.jsxs)("svg", {
				...
				children: [
					...
					!pointLabels && yLabels.map((label) => (0, react_jsx_runtime.jsx)("text", {
						x: AXIS_W - 5,
						y: label.y + 3,
						textAnchor: "end",
					...
					pointLabels && path.kind === "line" && path.coords.map((point, index) => {
						...
						return (0, react_jsx_runtime.jsx)("text", {
							...
							y: labelY,
							textAnchor: "middle",
							className: TokenHud_module_css_default.sparkPointLabel,
							children: text
						}, index);
					}),
					(0, react_jsx_runtime.jsx)("text", {
