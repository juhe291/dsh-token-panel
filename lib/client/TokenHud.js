...
function SessionRow({ row, prices, modelPrices, rangeMs, now, t, onHint, onHintEnd }) {
    ...
    return (_jsxs("div", { className: css.row, "data-open": open, children: [_jsxs("button", { type: "button", className: css.rowHead, onClick: () => { setOpen((current) => !current); }, "aria-expanded": open, children: [_jsxs("span", { className: css.rowName, onPointerEnter: (event) => { onHint(`${row.title ?? ''} ${row.sessionId}`, event.currentTarget); }, onPointerLeave: onHintEnd, children: [_jsx("span", { className: css.rowTitle, children: label }), row.title !== undefined && row.title !== '' && (_jsx("span", { className: css.rowSub, children: row.sessionId.slice(-8) }))] }), _jsxs("span", { className: css.rowTokensWrap, children: [_jsx("span", { className: css.rowTokens, onPointerEnter: (event) => { onHint(t('currentPressure'), event.currentTarget); }, onPointerLeave: onHintEnd, children: formatNumber(row.totalTokens) }), cumulative !== undefined && (_jsxs("span", { className: css.rowCumulative, onPointerEnter: (event) => { onHint(t('cumulativeUsage'), event.currentTarget); }, onPointerLeave: onHintEnd, children: [t('approx'), formatNumber(cumulative)] })), usage !== undefined && (_jsx("span", { className: css.rowCost, onPointerEnter: (event) => { onHint(t('costTitle'), event.currentTarget); }, onPointerLeave: onHintEnd, children: formatCost(cost) }))] }), _jsx("span", { className: css.rowPulse, "data-live": row.live, "aria-hidden": true })] }), open && (_jsxs("div", { className: css.rowDetail, children: [history.length >= 2 && _jsx(Sparkline, { points: history, now: now, follow: true, t: t }), _jsxs("div", { className: css.detailLine, children: [_jsxs("span", { className: css.detailItem, children: [_jsx("span", { className: css.detailLabel, children: t('input') }), _jsx("span", { className: css.mono, children: usage === undefined ? '—' : formatNumber(usage.uncachedInputTokens) })] }), _jsxs("span", { className: css.detailItem, children: [_jsx("span", { className: css.detailLabel, children: t('output') }), _jsx("span", { className: css.mono, children: usage === undefined ? '—' : formatNumber(usage.outputTokens) })] }), _jsxs("span", { className: css.detailItem, children: [_jsx("span", { className: css.detailLabel, children: t('cacheRead') }), _jsx("span", { className: css.mono, children: usage === undefined ? '—' : formatNumber(usage.cacheReadTokens) })] }), _jsxs("span", { className: css.detailItem, children: [_jsx("span", { className: css.detailLabel, children: t('cacheWrite') }), _jsx("span", { className: css.mono, children: usage === undefined ? '—' : formatNumber(usage.cacheWriteTokens) })] })] }), _jsxs("div", { className: css.detailLine, children: [_jsxs("span", { className: css.detailItem, children: [_jsx("span", { className: css.detailLabel, children: t('pressure') }), _jsx("span", { className: css.mono, children: row.pressureTokens === undefined ? '—' : formatNumber(row.pressureTokens) })] }), _jsxs("span", { className: css.detailItem, children: [_jsx("span", { className: css.detailLabel, children: t('projected') }), _jsx("span", { className: css.mono, children: row.projectedTokens === undefined ? '—' : formatNumber(row.projectedTokens) })] }), _jsxs("span", { className: css.detailItem, children: [_jsx("span", { className: css.detailLabel, children: t('capacity') }), _jsx("span", { className: css.mono, children: row.contextWindow === undefined ? '—' : formatNumber(row.contextWindow) })] }), _jsxs("span", { className: css.detailItem, children: [_jsx("span", { className: css.detailLabel, children: t('cost') }), _jsx("span", { className: css.mono, children: formatCost(cost) })] })] }), used !== undefined && (_jsx("div", { className: css.barTrack, "aria-label": fill(t('contextBar'), { pct: used.toFixed(0) }), children: _jsx("span", { className: css.barFill, style: { width: `${used}%` }, "data-hot": used > 85 }) }))] }))] }));
}
...
function StatsView({ stats, t, budgetMonthly, totalCost, effectiveBalance, editing, setEditing, editDraft, setEditDraft, editInputRef, onSave, onHint, onHintEnd }) {
    ...
    return (_jsxs("div", { className: css.statsBody, children: [_jsxs("section", { className: css.section, children: [_jsx("div", { className: css.statsTotal, children: _jsxs("div", { className: css.statsTotalRow, children: [_jsx("span", { className: css.statsTotalLabel, children: t('totalLabel') }), _jsx("span", { className: css.mono, children: formatNumber(totalAll) }), _jsxs("span", { className: css.statsTotalSub, children: [t('totalSub'), " \u00B7 ", t('approx'), formatCost(totalCost)] })] }) }), _jsxs("div", { className: css.budgetWrap, children: [_jsxs("div", { className: css.editRow, children: [_jsx("span", { className: css.editLabel, children: t('budgetLabel') }), renderEditor('budget', budgetMonthly > 0 ? budgetMonthly : null, budgetMonthly > 0 ? `${formatCost(monthCost)} / ${formatCost(budgetMonthly)}` : t('notSet'))] }), budgetMonthly > 0 && (_jsx("span", { className: css.budgetTrack, children: _jsx("span", { className: css.budgetFill, style: { width: `${Math.min(100, (monthCost / budgetMonthly) * 100)}%` }, "data-over": monthCost > budgetMonthly }) }))] }), _jsxs("div", { className: `${css.editRow} ${css.balanceEditRow}`, children: [_jsx("span", { className: css.editLabel, children: t('balanceLabel') }), renderEditor('balance', effectiveBalance, effectiveBalance !== null ? `¥${effectiveBalance.toFixed(2)}` : t('notSet'))] })] }), hasData && (_jsxs("section", { className: css.section, children: [_jsx("div", { className: css.sectionLabel, children: _jsxs("div", { className: css.viewBar, role: "group", "aria-label": t('granularity'), children: [_jsx("button", { type: "button", className: css.viewButton, "data-active": subView === 'days', onClick: () => { setListExpanded(false); setSubView('days'); }, children: t('byDay') }), _jsx("button", { type: "button", className: css.viewButton, "data-active": subView === 'months', onClick: () => { setListExpanded(false); setSubView('months'); }, children: t('byMonth') })] }) }), _jsx("div", { className: css.statsSparkWrap, children: subView === 'months'
                            ? (monthPoints.length >= 1 && (_jsx(Sparkline, { points: monthPoints, now: Date.now(), height: 80.5, hover: true, tickFormat: (value) => formatMonthTick(value, t), t: t })))
                            : (dayPoints.length >= 1 && (_jsx(Sparkline, { points: dayPoints, now: Date.now(), height: 80.5, hover: true, tickFormat: formatDateTick, t: t }))) }), listCount > 0 && (_jsxs(_Fragment, { children: [listExpanded && listItems, _jsxs("button", { type: "button", className: css.moreButton, onClick: () => { setListExpanded((current) => !current); }, children: [_jsx("span", { className: css.moreCaret, children: listExpanded ? '▴' : '▾' }), listExpanded
                                        ? t('collapseList')
                                        : subView === 'months'
