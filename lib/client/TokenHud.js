...
export function TokenHud({ t, sessionsList }) {
    ...
    const onDragMove = (event) => {
        ...
        // its grabbable handle reachable. The TOP edge keeps the full header
        // visible; the LEFT edge keeps the title text block (about 110px)
        // visible — otherwise an off-screen drag strands the handle.
        const VISIBLE = 48;
        const handleW = open ? 110 : drag.width;
        const minX = handleW - drag.width;
