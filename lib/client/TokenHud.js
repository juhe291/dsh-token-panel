...
export function TokenHud({ t, sessionsList }) {
    ...
    const onDragMove = (event) => {
        ...
        const hostEl = event.currentTarget.closest('[data-token-panel-host]');
    ...
    return (_jsxs("div", { className: css.host, style: hostStyle, children: [pressMenu && (_jsxs("div", { className: css.pressMenu, "data-press-menu": true, children: [_jsxs("button", { type: "button", className: css.pressMenuItem, onClick: () => {
                            resetPosition();
                            setPressMenu(false);
