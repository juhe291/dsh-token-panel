...
export function TokenHud({ t, sessionsList }) {
    ...
    useLayoutEffect(() => {
        if (!open || panelRef.current === null || position === null)
            return;
