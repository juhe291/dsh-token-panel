...
export function TokenHud({ t, sessionsList }) {
    ...
    const hostStyle = position !== null
        ...
        : {};
    if (snapshot === null) {
        return (_jsx("div", { className: css.host, style: hostStyle, "data-token-hud": true, children: _jsx(CollapsedChip, { total: 0, onClick: () => { setOpen(true); }, t: t }) }));
    }
    return (_jsxs("div", { className: css.host, style: hostStyle, "data-token-hud": true, children: [pressMenu && (_jsxs("div", { className: css.pressMenu, "data-press-menu": true, children: [_jsxs("button", { type: "button", className: css.pressMenuItem, onClick: () => {
                        ...
                        }, children: ["\u21BA ", t('backToCorner')] }), _jsx("button", { type: "button", className: css.pressMenuItem, onClick: () => { setPressMenu(false); }, children: t('cancelMenu') })] })), !open && (_jsx("div", { ...dragHandlers, style: { cursor: 'grab' }, children: _jsx(CollapsedChip, { total: totals.total, cumulative: totals.cumulative, tps: tps, onClick: () => {
